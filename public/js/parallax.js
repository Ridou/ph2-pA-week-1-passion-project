...
;(function ( $, window, document, undefined ) {
  ...
  $(document).on('ready.px.parallax.data-api', function () {
    ...
    $('#main').parallax({imageSrc: '../../assets/classroom2.jpg'});
    $('#mountain').parallax({imageSrc: '../../assets/classroom3.jpg'});
    $('#valley').parallax({imageSrc: '../../assets/classroom4.jpg'});
    $('#river').parallax({imageSrc: '../../assets/classroom5.jpg'});
  });
